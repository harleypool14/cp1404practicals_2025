...
"""Ask user for name and writes to file"""
...
"""Reads the stored name from file"""
...
"""Opens number file and reads two numbers and adds them together"""
...
"""Open and reads the numbers from the file"""
total = 0
with open("numbers.txt", "r") as in_file:
    for line in in_file:
        number = int(line)
